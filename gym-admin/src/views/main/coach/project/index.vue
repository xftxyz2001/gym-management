  ...
  <div class="layout-container">
    ...
    <div class="layout-container-form flex space-between">
      ...
      <div class="layout-container-form-search">
        ...
        <el-input v-model="query.description" placeholder="项目描述"></el-input>
    ...
    <Layer :layer="layer" @confirm="submit">
      <el-form ref="form" :model="formModel" label-width="100px">
        ...
        <el-form-item label="项目描述" prop="description">
          <el-input v-model="formModel.description" placeholder="请输入项目描述"></el-input>
        </el-form-item>
      </el-form>
    </Layer>
  </div>
...
<script setup>
import { saveProject, removeProject, removeProjects, updateProject, getProject, listProjects } from "@/api/course";
...
function getTableData() {
  listProjects(query, page.index, page.size).then(res => {
...
function submit() {
  if (formModel.value.id) {
    updateProject(formModel.value).then(() => {
      ElMessage.success("修改成功");
      layer.show = false;
      getTableData();
    });
  } else {
    saveProject(formModel.value).then(() => {
